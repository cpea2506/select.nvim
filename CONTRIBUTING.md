...
2. Clone and link your fork with this repository `git remote add upstream https://github.com/cpea2506/select.nvim.git`.
...
- Make sure all the [tests](tests/spec) pass locally before pushing with [`make test`](Makefile) command. Ex output:
  ...
  ========================================
  Testing:        select.nvim/tests/spec/highlight_spec.lua
...
- Your PR must pass all the [workflows](https://github.com/cpea2506/select.nvim/actions).
